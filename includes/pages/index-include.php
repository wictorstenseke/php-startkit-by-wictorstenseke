    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-12 text-center banner-header">
                ...
                <a href="/about.php" class="header-cta btn btn-lg btn-success" role="button">About Page</a>
            </div>
        </div><!-- /row -->
        ...
        <div class="row">
            ...
            <div class="project-stuff">
                <div class="col-sm-4 text-center">
                    <h1>🚀</h1>
                    <p>Spara tid genom att använda <code>php include</code> för att t.ex. repetera samma footer på alla sidor.</p>
                </div>
                <div class="col-sm-4 text-center">
                    <h1>📱&nbsp;💻</h1>
                    <p>Stöd för responsivitet genom det populära ramverket <code>Bootstrap-3.3.7</code>.</p>
                </div>
                <div class="col-sm-4 text-center">
                    <h1>🖌</h1>
